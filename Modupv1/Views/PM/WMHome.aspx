<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<Modupv1.Models.projViewModel>" %>
                      ...
                      <div class="profile-widget profile-widget-info">
                          <div class="panel-body">
                            ...
                            <div class="weather-category twt-category">
                                      <ul>
                                          <li class="active">
                                              <h4><%int count;try {  count = Model.tbProject.Where(p => p.status.Equals("Open")).ToList().Count; }
                                                    catch { count = 0; }%><%:count %></h4>
                                              <i class="icon_close_alt2"></i> Pending Task
                                          </li>
                                          <li>
                                              <h4><%int count2 = 0; %><%:count2 %></h4>
...
<% foreach (var item in Model.tbProject){ %>
                              <tr>
                                  <%--<td>
                                    <span class="profile-ava">
                                  ...
                                  <td>
                                     ...
                                     <a class="" href="<%:@Url.Action("project", "PM", new {id = prjID })%>"><p class="profile-name"><%: item.title %></p></a> 
                                      
                                  </td>
                                  <td>
                                      <p class="profile-name"><%: item.moduleNo %></p>
                                      
                                  </td>
                                  <td>
                                      <p class="profile-name"><%: item.postDate %></p>
