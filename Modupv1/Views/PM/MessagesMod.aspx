<%@ Page Title="" Language="C#" MasterPageFile="~/Views/PM/PMWorkroomModule.Master" Inherits="System.Web.Mvc.ViewPage<Modupv1.tbModuleWorkroom>" %>
                            ...
                            <div class="col-lg-12">
                                <section class="panel" style="">
                                        ...
                                        $(document).ready(function () {
                                            ...
                                            chat.client.broadcast = function (name, message, date, attachment) {
                                                ...
                                                if (attachment == "No Attachment") {
                                                    ...
                                                    attach = "<a href='http://localhost:49699/PM/DownloadWRMod/?id=" + <%:Model.wrID%> + "&filename=" + attachment + "'>" + attachment + "</a>";
                                                }
                                                var $tr = $('<tr>').append(
                                            ...
                                            $.connection.hub.start().done(function () {
                                                $('#btnSend').click(function (e) {
                                                    ...
                                                    var sender = '<%:Model.tbAwardedModule.tbModule.tbProject.tbPM.tbUser.firstName + Model.tbAwardedModule.tbModule.tbProject.tbPM.tbUser.firstName%>';
                                                    ...
                                                    if (f.files.length > 0) {
                                                        ...
                                                        if (window.FormData !== undefined) {
                                                            ...
                                                            $.ajax({
                                                                url: 'http://localhost:49699/PM/MessagesMod',
                                                                method: 'POST',
                                                                data: data,
                                                                processData: false,
                                                                contentType: false,
                                    ...
                                    <div class="col-lg-4 msg_div pull-right" style="padding: 1% 0 1% 1%; background-color: #f2f2f2;">
                                        ...
                                        <p><a href=""><%: Model.tbAwardedModule.tbModule.tbProject.tbPM.tbUser.firstName + " " + Model.tbAwardedModule.tbModule.tbProject.tbPM.tbUser.lastName %></a></p>
                                        <p><a href=""><%: Model.tbAwardedModule.tbDeveloper.tbClient.tbUser.firstName + " " + Model.tbAwardedModule.tbDeveloper.tbClient.tbUser.lastName %></a></p>
                                        ...
                                        success: function (response) {
                                            ...
                                            $.each(response, function (i, item) {
                                                ...
                                                if (item['attachment'] == "No Attachment") {
                                                    ...
                                                    attach = "http://localhost:49699/PM/DownloadWRMod/?id=" + <%:Model.wrID%> + "&filename=" + item['attachment'];
                                       }
                                       var $tr = $('<tr>').append(
