<%@ Page Title="" Language="C#" MasterPageFile="~/Views/PM/PMWorkroomModule.Master" Inherits="System.Web.Mvc.ViewPage<Modupv1.Models.FileModel>" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
                            ...
                            success: function (resp) {
                                $.each(resp, function (index,row) {
                                    $.each(row, function (key, value) {
                                        ...
                                        var $tr = $('<tr>').append(
                                           $('<td>').html("<a href='http://localhost:49699/PM/DownloadWRMod/?id="+<%:ViewBag.wr%>+"&filename="+value.filename+"'>" + value.filename + "</a>"),
            ...
            $('.btn.btn-danger').unbind().click(function () {
                ...
                $.ajax({
                    url: '<%:Url.Action("remFileModWR","PM")%>',
                    method: 'POST',
