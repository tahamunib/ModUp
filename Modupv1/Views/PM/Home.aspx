                          ...
                          <div class="panel-body">
                            <div class="col-lg-4 col-sm-4 profile-widget-name">
                              ...
                              <div class="follow-ava">
                                  <img id="img1" onclick="clicked()" src="/img/birds-of-paradise-sq.jpg" alt="">
                              </div>
                            </div>
                            <div class="col-lg-8 col-sm-8 follow-info">
                                ...
                                <h6 style="margin-top:7px;">
                                    <span><i class="icon_pin_alt"></i>Pakistan</span>
                                </h6>
                            </div>
                            <div class="weather-category twt-category">
                                      <ul>
                                          <li class="active">
                                              <h4><%int count;try {  count = Model.tbProjects.Where(p => p.status.Equals("Open") || p.status.Equals("Analysis") || p.status.Equals("Analyzed")).ToList().Count; }
                                                    catch { count = 0; }%><%:count %></h4>
                                              <i class="icon_close_alt2"></i> Pending Task
                                          </li>
                                          <li>
                                              <h4><%int count2; try { count2 = Model.tbProjects.Where(p => p.status.Equals("Closed")).ToList().Count; }
                                                    catch { count2 = 0; } %><%:count2 %></h4>
                                  ...
                                  <td>
                                      <% string prjID = Convert.ToString(item.projID);
                                         ...
                                         if(item.status.Equals("Analysis") || item.status.Equals("Analyzed")){
                                              action= "Submission";%>
                                                <a class="" href="<%:@Url.Action(action, "PM", new {id = item.tbAwardedProj.tbProjWorkrooms.First().wrID })%>"><p class="profile-name"><%: item.title %></p></a>
                                         <%}
