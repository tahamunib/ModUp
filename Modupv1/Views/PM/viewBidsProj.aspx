            ...
            <div class="row">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body project-team" style="background-color: #f9f9f9;">
                            <div class="task-progress col-md-offset-2">
                                <h1 style="margin-left: .5em; font-size: 4em; font-weight: lighter;">Project Proposals</h1>
                            </div>
                        </div>
                ...
                <div class="offset-to-mid-propTable">
                        ...
                        <table class="table table-striped table-advance table-hover" border="1" bordercolor="#f1f1f1">
                            <tbody>
                                <tr>
                                    <th class="table-head">REQUIREMENT ENGINEER BIDDINGS (<%:Model.tbProject.tbProjProposals.Count %>)</th>

                                    <th class="table-head">EXPERIENCE</th>
                                    <th class="table-head">TOTAL EARNING</th>
                                    <th class="table-head">BID (USD)</th>
                                </tr>
                                <%foreach (var prop in Model.tbProjProposals)
                                  { %>
                                <tr id="parent">
                                    <td>
                                        <table>
                                                    ...
                                                    <td>
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <th>
                                                                        <a href="#"><%: prop.tbRequirementEngineer.tbClient.tbUser.firstName %> <%: prop.tbRequirementEngineer.tbClient.tbUser.lastName %></a>
                                                                    </th>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <p><%: prop.tbRequirementEngineer.tbClient.overview %> </p>
                                                                    </td>
                                                                </tr>
                                    ...
                                    <td>
                                        <%: prop.tbRequirementEngineer.tbClient.awardedProjects %> Projects Completed
                                    </td>
                                    <td>$ <%: prop.tbRequirementEngineer.tbClient.totalEarning %>
                                    </td>
                                    <td>
                                        <span class="pull-left" style="padding-top: 4%; padding-right: 9%;"><%: prop.bidAmt %></span>
                                        <span class="pull-left">
                                            <% int id = prop.prjpropID; %>
                                            <a href="<%:Url.Action("viewProposal", "PM", new { id = id})%>" id="hover-content">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <form class="form-horizontal " method="get">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-10">
                                        <%: Html.PagedListPager(Model.tbProjProposals,page => Url.Action("viewBids",new {Model.tbProject.projID,page}))  %>
                                    </div>
                                </div>
                            </form>
                        </div>
