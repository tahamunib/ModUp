                  ...
                  <div class="col-lg-12">
                      <section class="panel" style="padding-bottom:3%; margin-bottom:3%;">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="register_form" method="post" action="<%: Url.Action("initiateProj", "PM") %>">
                                      ...
                                      <div class="form-group ">
                                           <label for="dtp_input1" class="col-md-2 control-label">DateTime Picking: <span class="required">*</span></label>
                                            <div class="input-group date form_datetime col-md-5" data-date="2016-01-21T05:25:07Z" data-date-format="dd MM yyyy " data-link-field="dtp_input1" style="padding-left:15px;">
                                          ...
                                          <div class="col-lg-10">
                                             <%-- <input class=" form-control" id="address" name="address" type="text" />--%>
                                               <%: Html.TextBoxFor(model => model.closeDate, new { @class = "form-control", @id = "dtp_input1", @type = "hidden"}) %>
                                      ...
                                      <%--<div class="form-group ">
                                          <label for="confirm_password" class="control-label col-lg-2">No of Modules <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="username" name="username" type="number" />
                                              <%: Html.TextBoxFor(model => model.moduleNo, new { @class = "form-control"}) %>
                                               <%: Html.ValidationMessageFor(model => model.moduleNo) %>
                                          </div>
                                      </div>--%>
                                      <div class="form-group ">
