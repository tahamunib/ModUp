       ...
       <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active">
                        <a href="<%:@Url.Action("BrowseProj", "RequirementEngineer")%>" class="">
                      ...
                      <section class="panel" >
                          <div class="panel-body project-team" style="background-color:#f9f9f9;">
                            <div class="task-progress col-md-offset-1">
                                  <h1 style="margin-left:0em; font-size:4em; font-weight:lighter;">Proposal for Requirement Analysis</h1>  
                            </div>
                        </div>
                          <br>
                        ...
                        <div class=" offset-to-mid">
                        	...
                        	<h1 style="margin-left:0em; font-size:2em; font-weight:bolder;"><%: Model.tbProject.title %></h1><br />
                          <section class="panel bidProposal-header-head">
                                  <div class="bidProposal-header">
                                  	<div class="col-md-10 pull-left bidProposal-header-left">
                                        <div class="bidProposal-header-left-firDiv">
                                            <h5>Bids</h5>
                                            <p><%: Model.tbProject.tbProjProposals.Count %></p>
                                        </div>
                                        
                                        <div class="bidProposal-header-left-secDiv">
                                            <h5>Estimated Amount(Whole Project)</h5>
                                            <p><%: Model.tbProject.estimatedAmt %></p>
                                        </div>
                                        <div class="bidProposal-header-left-secDiv">
                                            <h5>Status</h5>
                                            <p><%: Model.tbProject.status %></p>
                                        </div>
                                          <div class="bidProposal-header-left-fourDiv">
                                            <h5>Days Left</h5>
                                            <p><%: Convert.ToInt16((Convert.ToDateTime(Model.tbProject.closeDate) - DateTime.Now).TotalDays) %></p>
                                        </div>
                                    </div>
                                   <script src="/js/jquery.min.js"></script>
                                    ...
                                    <div class="col-md-2 pull-right bidProposal-header-right hidetext">
                                            <h5 class="bidButton">Bid on This Project</h5>
                                    </div>
                                    </a>
                                  </div>
                                  <div class="clearfix"></div>
                                  <% string mId = Convert.ToString(Model.tbProject.projID); %>
                                  <div class="bidProposal-footer text" style="display:none; border-bottom:2px solid #f1f1f1;">
                                            <h3>Bid: </h3>
                                                    <form class="form-horizontal " method="post" action="<%: Url.Action("submitProposalProj", "RequirementEngineer", new { id = mId})%>">
                                                         ...
                                                         <div class="form-group">
                                                              <div class="col-sm-12">
                                      						  <label class="col-sm-2 control-label"><div style="font-size:1.3em;">Your Bid:</div></label>
                                                                  ...
                                                                  <%: Html.TextBoxFor(model => model.tbProjProposal.bidAmt, new {@id="bid",@class = "form-control dollar-form-control", @placeholder="0",@onchange="rateChange()",@type = "number" })%>
                                                              </div>
                                                          </div>
                                                        ...
                                                        <div class="form-group">
                                                         ...
                                                         <div class="form-group">
                                                              <div class="col-sm-12">
                                      						  <label class="col-sm-2 control-label"><div style="font-size:1.3em;">Cover Letter:</div></label><label class="col-sm-2 control-label"><div style="font-size:1.3em;"><%: Html.TextAreaFor(model => model.tbProjProposal.coverLetter, new { @class = "form-control", @rows = "5", @style="width:750px"}) %></div></label>
                                                              </div>
                                                          </div>
                                                        <div class="form-group">
                                                              <div class="col-sm-12">
                                            ...
                                            <div class="input-group date form_datetime col-md-5" data-date="<%:System.DateTime.Today.ToString("yyyy-MM-dd")%>" data-date-format="dd MM yyyy " data-link-field="dtp_input1" style="padding-left:15px;">
                                                ...
                                                <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                                                                   ...
                                                                   <%: Html.TextBoxFor(model => model.tbProjProposal.estCompletion, new { @class = "form-control", @id = "dtp_input1", @type = "hidden"}) %>
                                  ...
                                  <div class="bidProposal-footer">
                                            <h3>Project Requirement Description</h3>
                                            <p><%: Model.tbProject.description %></p>
                                            <h3>Additional Files: </h3>
                                            <p><a href="<%:Url.Action("Download", "PM", new { filename = Model.tbProject.fileName })%>"><%:Model.tbProject.fileName %></a></p>
                         ...
                         <div class="offset-to-mid">
                                	<div >
                                          <table class="table table-striped table-advance table-hover" border="1" bordercolor="#f1f1f1">
                                               <tbody>
                                                  <tr>
                                                     <th class="table-head">FREELANCERS BIDDING (<%: Model.tbProject.tbProjProposals.Count %>)</th>
                                                     <th class="table-head">COMPLETED PROJECTS</th>
                                                     <th class="table-head">TOTAL EARNING</th>
                                                  </tr>
                                                  <tr>
                                                      <% foreach(var prop in Model.tbProject.tbProjProposals){ %>
                                                     <td>
                                                         <table>
                                                         <tbody>
                                                         <tr>
                                        ...
                                        <img src="/img/msa_logo-280x280.jpg" class="img-responsive img-circle" style="display:inline; border:3px solid rgba(0,0,0,0.1); margin-right:15px;" alt="Bird" width="100px" height="100px">
                                                            ...
                                                            <td>
                                                                 ...
                                                                 <tr>
                                                                    <th>
                                                                    <a href="<%:Url.Action("viewProfile","Developer", new {id = prop.tbRequirementEngineer.tbClient.userID }) %>"><%: prop.tbRequirementEngineer.tbClient.tbUser.firstName %> <%: prop.tbRequirementEngineer.tbClient.tbUser.lastName %></a>
                                                                    </th>
                                                                 </tr>
                                                                 </tbody>
                                                                 </table>
                                                     ...
                                                     <td><%: prop.tbRequirementEngineer.tbClient.awardedProjects %></td>
                                                     <td><%: prop.tbRequirementEngineer.tbClient.totalEarning %></td>
                                                  </tr>
                                                     <%} %>                          
                                               </tbody>
                                            </table>
                                      ...
                                      <section class="panel">
                                          <div class="panel-body">
                                              <form class="form-horizontal " method="get">
                                                  ...
                                                  <div class="form-group">
                                                      <div class="col-lg-10">
                                                          <%: Html.PagedListPager(Model.tbProjProposals,page => Url.Action("submitProposalProj",new {Model.tbProject.projID,page}))  %>
                                                      </div>
                                                  </div>
                                              </form>
                                          </div>
