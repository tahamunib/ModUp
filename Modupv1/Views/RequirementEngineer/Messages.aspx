<%@ Page Title="" Language="C#" MasterPageFile="~/Views/RequirementEngineer/RAWorkroom.Master" Inherits="System.Web.Mvc.ViewPage<Modupv1.tbProjWorkroom>" %>
                                ...
                                <section class="panel" style="">
                                    ...
                                    <div class="panel-body msg_div col-lg-7" style="padding: 1% 0 1% 1%; background-color: #f2f2f2;">
                                        <div class="form">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-11">
                                                        <textarea id="msg" class="form-control" rows="5" id="comment"></textarea>
                                                    </div>
                                                </div>
                                        ...
                                        $(document).ready(function () {
                                            ...
                                            chat.client.broadcast = function (name, message, date, attachment) {
                                                ...
                                                var $tr = $('<tr>').append(
                                                                       ...
                                                                       $('<td>').text(message),
                                                                       $('<td>').text(date),
                                                                       $('<td>').html("<a href='http://localhost:49699/RequirementEngineer/DownloadWR?id=" + <%:Model.wrID%> + "&?filename=" + attachment + "'>" + attachment + "</a>")
                                                                    ).prependTo('#tblBody');
                                            };
                                    ...
                                    $.connection.hub.start().done(function () {
                                        <%--$('#btnSend').click(function () {
                                            var msg = $('#msg').val();
                                            $.ajax({
                                                url: '<%:Url.Action("Messages","RequirementEngineer")%>',
                                                data: { id: '<%:ViewBag.wrID%>', message: msg },
                                                method: 'post',
                                        ...
                                        $('#btnSend').click(function () {
                                            ...
                                            if (f.files.length > 0) {
                                                ...
                                                if (window.FormData !== undefined) {
                                                    ...
                                                    $.ajax({
                                                        url: 'http://localhost:49699/RequirementEngineer/Messages',
                                                        method: 'POST',
                                                        data: data,
                                                        processData: false,
                                                        contentType: false,
                               ...
                               success: function (response) {
                                   ...
                                   $.each(response, function (i, item) {
                                       ...
                                       if (item['attachment'] == "No Attachment") {
                                           ...
                                           attach = "http://localhost:49699/RequirementEngineer/DownloadWR?id=" + <%:Model.wrID%> + "&filename=" + item['attachment']
                                       }
                                       var $tr = $('<tr>').append(
