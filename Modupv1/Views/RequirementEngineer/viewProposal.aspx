<%@ Page Title="" Language="C#" MasterPageFile="~/Views/RequirementEngineer/RAMasterPage.Master" Inherits="System.Web.Mvc.ViewPage<Modupv1.Models.proposalViewModel>" %>
                        ...
                        <table class="table table-striped table-advance table-hover" border="1" bordercolor="#f1f1f1">
                            <tbody>
                                ...
                                <tr id="parent">
                                        ...
                                        <table>
                                            <tbody>
                                                <tr style="margin-left:2%;">
                                                    ...
                                                    <td>
                                                        <a style="font-size:25px;" href="<%: Url.Action("viewProfile", new { id = Model.tbProjProposal.tbRequirementEngineer.tbClient.userID})%>"><%: Model.tbProjProposal.tbRequirementEngineer.tbClient.tbUser.firstName %> <%: Model.tbProjProposal.tbRequirementEngineer.tbClient.tbUser.lastName %></a>      
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <td>
                                        <%: Model.tbProjProposal.tbRequirementEngineer.tbClient.awardedProjects %> Projects Analysed
                                    </td>
                                    <td>$ <%: Model.tbProjProposal.tbRequirementEngineer.tbClient.totalEarning %>
                                    </td>
                                    <td>$ <%: Model.tbProjProposal.bidAmt %>
                                    </td>
                                </tr>
                                    ...
                                    <div class="panel-body">
                                        <div class="form">
                                            ...
                                            <div class="form-group ">
                                                <label for="fullname"  class="control-label col-lg-2"> Overview: </label>
                                                <div class="col-lg-10">
                                                    
                                                   <p><%:  Model.tbProjProposal.tbRequirementEngineer.tbClient.overview %></p> 
                                                </div>
                                                <br />
                                                 <label for="fullname" class="control-label col-lg-2">Cover Letter: </label>
                                                <div class="col-lg-10">
                                                    
                                                    <p><%:  Model.tbProjProposal.coverLetter %></p>
                                                </div>
                                            </div>
