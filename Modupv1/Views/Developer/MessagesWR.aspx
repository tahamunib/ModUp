                                        ...
                                        $(document).ready(function () {
                                            ...
                                            chat.client.broadcast = function (name, message, date, attachment) {
                                                ...
                                                if (attachment == "No Attachment") {
                                                    attach = "<a href='#'>No Attachment</a>";
                                                } else {
                                                    attach = "<a href='http://localhost:49699/Developer/DownloadWRMod/?id=" + <%:Model.wrID%> + "&filename=" + attachment + "'>" + attachment + "</a>";
                                                }
                                                var $tr = $('<tr>').append(
                                            ...
                                            $.connection.hub.start().done(function () {
                                                $('#btnSend').click(function (e) {
                                                    ...
                                                    var sender = '<%:Model.tbAwardedModule.tbDeveloper.tbClient.tbUser.firstName + Model.tbAwardedModule.tbDeveloper.tbClient.tbUser.firstName%>';
                                                    ...
                                                    if (f.files.length > 0) {
                                                        ...
                                                        if (window.FormData !== undefined) {
                                                            ...
                                                            $.ajax({
                                                                url: 'http://localhost:49699/Developer/MessagesWR',
                                                                method: 'POST',
                                                                data: data,
                                                                processData: false,
                                                                contentType: false,
                        ...
                        <script type="text/javascript">
                            $(document).ready(function () {
                                ...
                                function updateMessagesAll() {
                                    $("#tblMsg > tbody").html("");
                                    $.ajax({
                                        url: '<%:Url.Action("MessagesWR","Developer")%>',
                                        method: 'GET',
                                        ...
                                        success: function (response) {
                                            ...
                                            $.each(response, function (i, item) {
                                                ...
                                                if (item['attachment'] == "No Attachment") {
                                                    ...
                                                    attach = "http://localhost:49699/Developer/DownloadWRMod/?id=" + <%:Model.wrID%> + "&filename=" + item['attachment'];
                                                }
                                                var $tr = $('<tr>').append(
