                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="/img/default_avatar_male.jpg" width="35" height="35">
                            </span>
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="<%:Url.Action("Logout","Account") %>"><i class="icon_key_alt"></i>Log Out</a>
                            </li>
                            <!-- <li>
                                        ...
                                        <div class="row margin-top-more">
                                            <div class="form-group ">
                                                <div class="col-md-12">
                                                    ...
                                                    <%: Html.DropDownListFor(model => model.tbUser.country,new List<SelectListItem> { }, new { @id="country", @class = "form-control"})%>
                                            ...
                                            <div class="form-group ">
                                                <div class="col-md-12">
                                                    <h1 class="h3 cust-h">State</h1>
                                                     <%: Html.DropDownListFor(model => model.tbUser.state,new List<SelectListItem> { }, new { @id="state", @class = "form-control"})%>
                                                </div>
                                            </div>
