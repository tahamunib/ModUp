                        ...
                        <section class="panel">
                            <div class="panel-body project-team" style="background-color: #f9f9f9;">
                                <div class="task-progress col-md-offset-2">
                                    <h1 style="margin-left: 0em; font-size: 4em; font-weight: lighter;">Skill Evaluation:</h1>
                                </div>
                            </div>
                            ...
                            <div class="offset-to-mid">
                                ...
                                <div class="row margin-top-more">
                                    ...
                                    <div class="col-md-offset-5" style="padding-top: 1em;">
                                        <img src="/img/default_avatar_male.jpg" class="img-responsive img-thumbnail" style="display: inline; border: 3px solid rgba(0,0,0,0.1);" alt="Bird" width="130px" height="130px">
                                ...
                                <% int uid = Model.tbUser.userID; %>
                                <form class="form-validate form-horizontal " id="register_form" method="post" action="<%: Url.Action("skillEnquiry", "Developer", new { id=uid})%>">
                                    <div class="form">
                                        <div class="row margin-top-more">
                                            <div class="form-group ">
                                                <div class="col-md-12">
                                                    <h1 class="h3 cust-h">Please Enter your skill to evaluate:</h1>
                                                       <%:
                   Html.DropDownListFor(model => model.tbSkill.name,new List<SelectListItem> { 
                       new SelectListItem { Value = "Javascript" , Text = "Javascript" },
                       new SelectListItem { Value = "Csharp" , Text = "Csharp" },
