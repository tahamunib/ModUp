<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<IPagedList<Modupv1.tbModule>>" %>
                                               ...
                                               <tbody>
                                                  <tr>
                                                     ...
                                                     <th class="table-head">Skill Level</th>
                                                      ...
                                                      <th class="table-head">Development Type</th>
                                                  </tr>
                                              ...
                                              <form class="form-horizontal " method="get">
                                                  ...
                                                  <div class="form-group">
                                                      <div class="col-lg-10">
                                                         ...
                                                         <%: Html.PagedListPager(Model,page => Url.Action("Browse",new {page,ViewBag.budget,ViewBag.skill,q}))  %>
                                                      </div>
                                                  </div>
                                              </form>
                                          </div>
