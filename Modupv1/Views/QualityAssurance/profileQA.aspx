<%@ Page Title="" Language="C#" MasterPageFile="~/Views/QualityAssurance/QAMasterPage.Master" Inherits="System.Web.Mvc.ViewPage<Modupv1.Models.profileViewModel>" %>
                        ...
                        <div class="offset-to-mid">
                        	...
                        	<div class="row margin-top-more">
                                ...
                                <div class="col-md-7">
                                	...
                                	<h1 class="h4 cust-h" style="margin-bottom:0;"><%: Model.QA.tbClient.tagLine %></h1>
                            ...
                            <div class="row margin-top-more">
                                <div class="col-md-12">
                                	...
                                	<h1 class="h4 cust-h"><%:Model.QA.tbClient.overview %></h1>
                                </div>
                                <div class="col-md-12">
